...
class ThirdParty {
  ...
  ThirdParty({
    ...
    required this.prefixCustomerIsRequired,
    ...
    required this.socialobject,
    required this.tvaAssuj,
    required this.tvaIntra,
    required this.vatReverseCharge,
    required this.localtax1Assuj,
    required this.localtax1Value,
    required this.localtax2Assuj,
    required this.localtax2Value,
    required this.managers,
    required this.capital,
    required this.typentId,
    required this.typentCode,
    required this.effectif,
    required this.effectifId,
    required this.formeJuridiqueCode,
    ...
    required this.modeReglementSupplierId,
    required this.condReglementSupplierId,
    required this.transportModeSupplierId,
    ...
    required this.codeComptaClient,
    required this.codeCompta,
    required this.accountancyCodeCustomer,
    required this.codeComptaFournisseur,
    required this.accountancyCodeSupplier,
    required this.codeComptaProduct,
    required this.notePrivate,
    required this.notePublic,
    required this.stcommId,
    required this.stcommPicto,
    required this.statusProspectLabel,
    required this.priceLevel,
    required this.outstandingLimit,
    required this.orderMinAmount,
    required this.supplierOrderMinAmount,
    required this.parent,
    required this.defaultLang,
    required this.ref,
    required this.refExt,
    required this.importKey,
    required this.webservicesUrl,
    required this.webservicesKey,
    required this.logo,
    required this.logoSmall,
    required this.logoMini,
    required this.logoSquarred,
    required this.logoSquarredSmall,
    required this.logoSquarredMini,
