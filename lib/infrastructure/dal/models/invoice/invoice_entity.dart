...
List<InvoiceEntity> parseInvoicesFromJson(List<dynamic> jsonList) {
  return jsonList.map((invoiceJson) {
    final invoice = InvoiceEntity(
      ...
      fkSociete: invoiceJson['socid'] is int
          ? invoiceJson['socid']
          : int.tryParse(invoiceJson['socid']?.toString() ?? '0'),
      ...
      sumcreditnote: invoiceJson['sumcreditnote'],
