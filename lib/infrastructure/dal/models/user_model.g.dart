...
class UserModelAdapter extends TypeAdapter<UserModel> {
  ...
  UserModel read(BinaryReader reader) {
    ...
    return UserModel(
      ...
      datec: fields[39] as int?,
      datem: fields[41] as int?,
      ...
      datelastlogin: fields[61] as int?,
      datepreviouslogin: fields[63] as int?,
      flagdelsessionsbefore: fields[65] as int?,
